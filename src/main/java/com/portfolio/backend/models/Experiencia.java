...
public class Experiencia {
    ...
    public Experiencia(String nombreExperiencia, String descripcionExperiencia, String tituloExperiencia, String fechaInicialExperiencia, String fechaFinalExperiencia, String imgExperienciaURL) {
